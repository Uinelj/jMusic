...
//		buf.add(doMajChords.betaModulate());
...
//		
		...
		ChordLoop buf = new ChordLoop(clg.getPrettyChordSuite(8));
...
//		System.out.println(clg2.getChordCollection().getHarmonizedChords());
//		System.out.println(clg.getModulationChords(laMin, 4));

...
public class MelodyBasic extends MelodyGenerator{

	private Melody melody;
	private Scale scale;
	private PianoNotes piano;
	private int melodySize;
	public MelodyBasic(Scale scale, int melodySize) 
	{
		this.scale=scale;
		melody = new Melody();
	...
	Integer rules(Integer position)//donne la position de la prochaine note à générer
	{
